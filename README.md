...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create up-n-down-topics-2947
  fly apps create up-n-down-topics-2947-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app up-n-down-topics-2947
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app up-n-down-topics-2947-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'up-n-down-topics-2947-staging' does not match app name in config file 'up-n-down-topics-2947'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name up-n-down-topics-2947-db
  fly postgres attach --app up-n-down-topics-2947 up-n-down-topics-2947-db

  fly postgres create --name up-n-down-topics-2947-staging-db
  fly postgres attach --app up-n-down-topics-2947-staging up-n-down-topics-2947-staging-db
  ```
